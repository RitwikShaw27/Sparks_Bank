...
<body style="background-image:url('statics/5570834-min.jpg'); ">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link active text-nowrap" href="contact.php">Contact Us</a>
                    </li>
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <!-- <img src="statics/Ritwik.jpeg" alt="" style="width:20%; box-shadow:2px 2px 15px black;"> -->
            <br><br>
            <p style="color:white;">
            <a href="mailto: shawritwik2@gmail.com" style="font-size: 30px; color: white ;text-decoration: none"> Email ID : shawritwik2@gmail.com </a>
            </p>
            <!-- <h1 style="color:white; text-shadow:2px 2px 2px gray;">RITWIK SHAW</h1> -->
            <p style="color:white;">
            <a href="https://www.linkedin.com/in/ritwik-shaw/" style="font-size: 30px; color: white ;text-decoration: none"> LinkedIn : RITWIK SHAW </a>
            </p>
    </center>
