...
<body style="background-image:url('statics/5570834-min.jpg'); ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; margin-right:75px;">
                        <a class="nav-link active text-nowrap" href="about.php">About Us</a>
                    </li>
                </ul>
            </b>
        </div>
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>            
            <br><br>
            <p style="color:white"> SPARK Bank Limited is an Indian banking and financial services company, headquartered in Kolkata, West Bengal. SPARK Bank is India's largest private sector bank by assets and by market capitalisation as of September 2021. </p>
            <p style="color:white;">This website is created by</p>
            <h2 style="color:white; text-shadow:2px 2px 2px gray;">RITWIK SHAW</h2>
            <p style="color:gray;"><b>Intern at The Sparks Foundation <br> RCC Institute of Information Technology, Kolkata</b></p>
    </center>
